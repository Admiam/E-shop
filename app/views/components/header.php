            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto">
                        ...
                        <?php
                        if ($tplData["userLogged"] && ($tplData["perm_id"] == 1) || ($tplData["perm_id"] == 2)) {
                        ...
                        if ($tplData["userLogged"] && ($tplData["perm_id"] == 1) || ($tplData["perm_id"] == 2) || ($tplData["perm_id"] == 3)) {
                            ?>
                            <li class="nav-item dropdown">
                    ...
                    <a href="index.php?page=cart" class="mr-4"><i class="fa-solid fa-basket-shopping nav-icons btn-primary"></i></a>
                    <?php
                    if ($tplData["userLogged"]) {
                        ...
                        <form action="index.php?page=main" style="margin-block-end: auto;" method="POST">
                            <input type="hidden" name="logout" value="logout" class=" all-full">
